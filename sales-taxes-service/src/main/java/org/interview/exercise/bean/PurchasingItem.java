...
public class PurchasingItem {
    ...
    public boolean equals(Object o) {
        ...
        if (unitPrice != null ? unitPrice.compareTo(item.unitPrice) != 0 : item.unitPrice != null) return false;
        if (salesTax != null ? salesTax.compareTo(item.salesTax) != 0 : item.salesTax != null) return false;
        return !(getTotalPrice() != null ? getTotalPrice().compareTo(item.getTotalPrice()) != 0 : item.getTotalPrice() != null);
    }
